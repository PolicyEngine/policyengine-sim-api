...
def validate_country_worker(
    *,
    ...
    # Import the same HTTP persistence client and coordinator modules loaded by
    # a real report run before publishing the manifest.
    import_module("policyengine_stage12_client")
